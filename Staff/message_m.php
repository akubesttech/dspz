                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2><a href="message_m.php">Message Inbox </a><big>(<?php
								$sql_countrow = mysqli_query($condb,"SELECT * FROM b_pms WHERE receiver='$staff_id'");
							$result=mysqli_num_rows($sql_countrow);
							echo $result;
							$sql_countrowsend = mysqli_query($condb,"SELECT * FROM b_pms WHERE sender='$staff_id'");
                  ...
                  <div class="x_content">
                    <div class="row">
                      ...
                      <a href="message_m.php?view=c_Msg" class="btn btn-sm btn-success btn-block" >COMPOSE</a>
                        ...
                        <?php if($results > 0){
        $sql_countread = mysqli_query($condb,"SELECT *,UNIX_TIMESTAMP() - therealtime AS TimeSpent FROM b_pms WHERE sender='$staff_id' order by therealtime DESC limit 0,4");
