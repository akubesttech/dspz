...
$sendmessage=mysqli_query($condb,"INSERT into b_pms (sender, receiver,subject,message,therealtime,vartime,s_status,r_status) values('$staff_id','$adminid','$subject','$message','$date','$vartime','0','$sender_counts')") or die("Could not send message");
...
$sendmessage=mysqli_query($condb,"INSERT into b_pms (sender, receiver,subject,message,therealtime,vartime,s_status,r_status) values('$staff_id','$regnopass','$subject','$message','$date','$vartime','1','$sender_counts')") or die("Could not send message");
message("Your Message was Successfully Sent.", "success");
		        redirect('message_m.php?view=c_Msg');
			}}
...
$sendmessage=mysqli_query($condb,"INSERT into b_pms (sender, receiver,subject,message,therealtime,vartime,s_status,r_status) values('$staff_id','$usern_id','$subject','$message','$date','$vartime','2','$sender_counts')") or die("Could not send message");
 message("Your Message was Successfully Sent.", "success");
		        redirect('message_m.php?view=c_Msg');
}}
