...
$query2_fac = @mysqli_query($condb,"select fac_name from faculty where fac_id = '$get_RegNo' ")or die(mysql_error());
...
$query_hoster = mysqli_query($condb,"select * from roomdb where room_no = '$h_coder'")or die(mysql_error());
//$row = mysqli_fetch_array($query);
$row_hoster = mysql_num_rows($query_hoster);
...
,'$r_st')")or die(mysql_error());

mysqli_query($condb,"insert into activity_log (date,username,action) values(NOW(),'$admin_username','Room  $h_coder was Add')")or die(mysql_error()); 
 ob_start();
 ...
 <div class="modal-header">
		...
		<div class="well profile_view" style="1px solid green;">
					<form method="post"   enctype="multipart/form-data" >
					  <?php
					$user_home = mysqli_query($condb,"select * from hostedb where h_code='$_GET[idroom]'")or die(mysql_error());
