                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                       <?php
                       if($_GET['unread'] == "234"){
$user_query = mysqli_query($condb,"select * from b_pms where receiver='$staff_id' and hasread = '0' order by therealtime DESC")or die(mysqli_error($condb));
					}else{
	$user_query = mysqli_query($condb,"select * from b_pms where receiver='$staff_id' order by therealtime DESC")or die(mysqli_error($condb));
				}
	...
	<img src="<?php if($studentimagein['images']==NULL ){
	print "./uploads/NO-IMAGE-AVAILABLE.jpg";
	}else{
	print $studentimagein['images'];
	
} ?>" style="width:50px;height:30px;" class="avatar" alt="image" />
	<?php	}elseif($row_f['r_status']=='2'){ ?>
	<img src="../admin/<?php if($staffimagevin['image']==NULL ){
	print "./uploads/NO-IMAGE-AVAILABLE.jpg";
	}else{
	print $staffimagevin['image'];
