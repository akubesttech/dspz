...
<style type="text/css" media="print"> @media print { a[href]:after {content: none !important;}} @page { size: landscape; margin: 0;}
...
<table cellpadding="0" cellspacing="0" align="center" class="table" >
  ...
  //array_push($all_property, $get_proc2->course_code);?> <td rowspan="2" colspan="<?php echo $numofcos; ?>"><?php //echo $coursecode; ?></td><?php //}  ?>
