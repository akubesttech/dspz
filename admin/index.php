...
//Indigene
$qindigene=mysqli_query($condb,"SELECT  SUM(f_amount)as totalamounti  FROM fee_db where  ft_cat = '1' and Cat_fee = '1'  and program ='".safee($condb,$class_ID)."' "); $get_amountin = mysqli_fetch_array($qindigene);  if($clind > 0 ){$amountin = $get_amountin['totalamounti']/$clind;}else{ $amountin = $get_amountin['totalamounti'];} 
...
if ( $Hour >= 5 && $Hour < 12 ) {
    ...
    <?php   if($Rorder == 1 || $Rorder == 2 || $Rorder == 3 || $Rorder == 4  || $Rorder == 8 ){//if (authorize($_SESSION["access3"]["dboard"]["main"]["delete"])){ ?>                     
...
?>
            ...
            <?php
              ...
              <?php // } ?>
              <?php  if($Rorder == 1 || $Rorder == 2 || $Rorder == 3 || $Rorder == 4  || $Rorder == 5 || $Rorder == 6){  //if (authorize($_SESSION["access3"]["dboard"]["main"]["create"])){ ?>
		 ...
		 ?>	<?php if($Rorder == 1 || $Rorder == 2 || $Rorder == 3 || $Rorder == 4  || $Rorder == 5 || $Rorder == 6 || $Rorder == 7){  //if (authorize($_SESSION["access3"]["dboard"]["main"]["view"])){ ?>
                       <div class="animated flipInY col-lg-4 col-md-3 col-sm-6 col-xs-12">
                        <div class="tile-stats">
		 ...
		 <?php if($Rorder == 1 || $Rorder == 2 || $Rorder == 8 ){  //if (authorize($_SESSION["access3"]["dboard"]["main"]["edit"])){ ?>
                       <div class="animated flipInY col-lg-4 col-md-3 col-sm-6 col-xs-12">
                        <div class="tile-stats">
              ...
              <?php if($Rorder == 1 || $Rorder == 2 || $Rorder == 3 || $Rorder == 4  || $Rorder == 8 ){  //if (authorize($_SESSION["access3"]["dboard"]["main"]["create"])){ ?>
               <div class="animated flipInY col-lg-4 col-md-3 col-sm-6 col-xs-12">
                        <div class="tile-stats">
                                      	<?php 
		 ...
		 ?>	
                       ...
                       <?php }?>
                       <?php if($Rorder == 1 || $Rorder == 2 || $Rorder == 3 ){  //if (authorize($_SESSION["access3"]["dboard"]["main"]["delete"])){ ?>
                      <div class="animated flipInY col-lg-4 col-md-3 col-sm-6 col-xs-12">
                        <div class="tile-stats">
                        	<?php 
...
//echo dateDiff($academic2, $curdate);
		 ...
		 ?><?php if($Rorder == 1 || $Rorder == 2 ){  //if (authorize($_SESSION["access3"]["dboard"]["main"]["create"])){ ?>
                      <div class="animated flipInY col-lg-4 col-md-3 col-sm-6 col-xs-12">
                        <div class="tile-stats">
		 ...
		 $dept_count = mysqli_num_rows($dept_query);
          if($Rorder == 1 || $Rorder == 2 ){  //if (authorize($_SESSION["access3"]["dboard"]["main"]["create"])){ ?>
                        <div class="animated flipInY col-lg-4 col-md-3 col-sm-6 col-xs-12">
                        <div class="tile-stats">
                          <div class="icon"><i class="fa fa-university"></i>
                          </div>
                        ...
                        <a href="add_Dept.php">							  
                            ...
                            <?php } ?>
<?php $utme_query = mysqli_query($condb,"select * from new_apply1 where  reg_status = '1' and Asession = '".safee($condb,$default_secadmin)."' and app_type = '".safee($condb,$class_ID)."'  ")or die(mysqli_error($condb));
...
</h3></h3> <?php  if($Rorder == 1 || $Rorder == 2 || $Rorder == 3 || $Rorder == 4  || $Rorder == 5 || $Rorder == 6 || $Rorder == 7){  //if (authorize($_SESSION["access3"]["dboard"]["main"]["view"])){ ?>
                       ...
                       <div class="animated flipInY col-lg-4 col-md-3 col-sm-6 col-xs-12">
...
</h3></h3> <?php if($Rorder == 1 || $Rorder == 2 || $Rorder == 6){  //if (authorize($_SESSION["access3"]["dboard"]["main"]["view"])){ ?>
                        <a href="add_Courses.php?view=ViewCourses">							  
                             ...
                             <?php } ?>
                                       ...
                                       $viewutme_querycon=mysqli_query($condb,"select * from course_allottb where assigned ='$staffmainid' and session ='$default_session'  and semester='$default_semester' ");
	             $count_courseallot = mysqli_num_rows($viewutme_querycon);
	    
		 ?><?php if($Rorder == 1 || $Rorder == 10 ){  //if (authorize($_SESSION["access3"]["dboard"]["main"]["view"])){ ?>
                      <div class="animated flipInY col-lg-4 col-md-3 col-sm-6 col-xs-12">
                        <div class="tile-stats">
	  ...
	  $sqlattend = "SELECT EmpID,Prensent,AttDate, COUNT(*) FROM attendance where staff_id2='$staffmainid' and  Prensent = '1' and  AttDate = '$datetoday'  GROUP by EmpID "; $resultat = mysqli_query($condb, $sqlattend) or die (mysqli_error($condb)); 
