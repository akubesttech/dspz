 ...
 */
class Pagination{
    //var $baseURL        = 'post.php?view=Dept';
    var $baseURL        = 'post.php?view=q';
    var $totalRows      = '';
    var $perPage         = 3;
    var $numLinks        =  1;
    var $currentPage    =  0;
    var $firstLink       = '<img src="./assets/media/first2d.png" alt="&lsaquo; First ">';
    var $nextLink        = '<img src="./assets/media/lasts.png" alt="&gt;">';
    var $prevLink        = '<img src="./assets/media/firstds.png" alt="&lt;">';
    var $lastLink        = '<img src="./assets/media/lastb.png" alt="Last &rsaquo;">';
    ...
    function createLinks(){ 
        ...
        if ($numPages == 1){
            if ($this->showCount){
                ...
                $info = '1 - ' . $this->totalRows . ' of ' . $this->totalRows;
                return $info;
            }else{
                return '';
            }
