...
//if($level=="Others"){
mysqli_query($condb,"insert into faculty (fac_name,fac_desc,fac_email,fac_phone,fac_dean) values('$fac_name','$fac_desc','$fac_email','$fac_phone','$fac_dean')")or die(mysqli_error($condb));
