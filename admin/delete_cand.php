...
{ $sql="select * from electiontb where id='".$id[$i]."'  and eend >'".$date_now."' ";
	...
	extract($row);
	$result = mysqli_query($condb,"DELETE FROM electiontb where id='$id[$i]' ");
$result2 = mysqli_query($condb,"DELETE FROM candidate_tb where ecate  ='".$ecate."'");
}
