...
//exit;
    ...
    */ // <!-- end --!>
        ...
        $res = $this->_ole->read("temp/".$sFileName);
        ...
        if($res === false) {
            ...
            // bad file
               ...
               message("The upload file with filename " . $sFileName . " is not readable!","error");
            redirect("Result_am.php?view=aimp_re");
              //if(file_exists("./temp/".$sFileName)){unlink("./temp/".$sFileName);}
            }
