...
echo "<script>window.location.assign('apply_b.php?view=ep_view');</script>";
  ...
  <div class="container">
    ...
    <div class="boxes-holder" style="background-color:#D9F7FD;font-size:14px;font-family:'Open Sans','Helvetica Neue','Helvetica',Arial,Verdana,sans-serif;color:#666666;max-width:980px;min-width:150px">
       ...
       <h3 style="color:orange;text-shadow:0 2px 1px black;">Order Payment Information Preview .</h3><br>
		...
		<form name="register2" action="https://voguepay.com/pay/" method="post" enctype="multipart/form-data" id="register2">
			...
			<input type='hidden' name='merchant_ref' value='<?php echo $_SESSION['emailp'];?>' />
            ...
            <input type='hidden' name='memo' value='<?php echo $_SESSION['ftype2'];?>' />
...
?></center></td>
    ...
    <td colspan="5" height="39" style="text-shadow: 2px 2px white;"><strong>&nbsp;Pin Order Transaction Summary </strong></td>
  ...
  <td width="20%" colspan="1" height="15"><strong>Full Name:</strong></td>
    <td width="31%" colspan="4"><?php echo $_SESSION['snamef']." ".$_SESSION['oname']; ?></td>
    </tr>
    <tr class="row1">
  <td width="20%" colspan="1" height="20"><strong>Email:</strong></td>
   ...
   <tr class="row1">
    ...
    <td width="20%" colspan="4"><?php echo $_SESSION['ftype2']." Form" ;?></td>
