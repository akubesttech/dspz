                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                       <?php
$user_query = mysqli_query($condb,"SELECT *,UNIX_TIMESTAMP() - therealtime AS TimeSpent FROM b_pms WHERE sender='$student_RegNo' order by therealtime DESC limit 0,4")or die(mysqli_error($condb));
