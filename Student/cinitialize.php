...
if(!$tranx->status){
  ...
  print_r("<a href=".$urllogin."changeofcourse_m.php?view=capply class='button' target='_self'><br>if this page still display after 30 sec ..<br> Click Here to <strong> GO Back </strong> to Initiate the Payment Again. </a></strong>"); 
}
